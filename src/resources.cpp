...
void loadshared()
{
  ...
  // printf("[DEBUG] loadshared: Starting shared resource loading...\n");

  sprite_manager = new SpriteManager(datadir + "/supertux.strf");
  // printf("[DEBUG] SpriteManager initialized with %s/supertux.strf\n", datadir.c_str());

  music_manager = new MusicManager();
  music_manager->enable_music(use_music);
  // printf("[DEBUG] MusicManager initialized (music %s)\n", use_music ? "enabled" : "disabled");

  /* Tuxes: */
  // printf("[DEBUG] Loading Tux sprites...\n");
  ...
  // printf("[DEBUG] SmallTux sprites loaded.\n");
  ...
  // printf("[DEBUG] LargeTux sprites loaded.\n");
  ...
  // printf("[DEBUG] FireTux sprites loaded.\n");

  /* Water: */
  // printf("[DEBUG] Loading water/waves...\n");
  img_water = new Surface(datadir + "/images/shared/water.png", IGNORE_ALPHA);
  img_waves[0] = new Surface(datadir + "/images/shared/waves-0.png", USE_ALPHA);
  img_waves[1] = new Surface(datadir + "/images/shared/waves-1.png", USE_ALPHA);
  img_waves[2] = new Surface(datadir + "/images/shared/waves-2.png", USE_ALPHA);

  /* Pole: */
  // printf("[DEBUG] Loading pole graphics...\n");
  img_pole = new Surface(datadir + "/images/shared/pole.png", USE_ALPHA);
  img_poletop = new Surface(datadir + "/images/shared/poletop.png", USE_ALPHA);

  /* Flag: */
  // printf("[DEBUG] Loading flags...\n");
  img_flag[0] = new Surface(datadir + "/images/shared/flag-0.png", USE_ALPHA);
  img_flag[1] = new Surface(datadir + "/images/shared/flag-1.png", USE_ALPHA);

  /* Clouds: */
  // printf("[DEBUG] Loading clouds...\n");
  img_cloud[0][0] = new Surface(datadir + "/images/shared/cloud-00.png", USE_ALPHA);
  img_cloud[0][1] = new Surface(datadir + "/images/shared/cloud-01.png", USE_ALPHA);
  img_cloud[0][2] = new Surface(datadir + "/images/shared/cloud-02.png", USE_ALPHA);
  img_cloud[0][3] = new Surface(datadir + "/images/shared/cloud-03.png", USE_ALPHA);

  img_cloud[1][0] = new Surface(datadir + "/images/shared/cloud-10.png", USE_ALPHA);
  img_cloud[1][1] = new Surface(datadir + "/images/shared/cloud-11.png", USE_ALPHA);
  img_cloud[1][2] = new Surface(datadir + "/images/shared/cloud-12.png", USE_ALPHA);
  img_cloud[1][3] = new Surface(datadir + "/images/shared/cloud-13.png", USE_ALPHA);

  /* Bad guys and upgrades: */
  // printf("[DEBUG] Loading badguy graphics...\n");
  load_badguy_gfx();
  // printf("[DEBUG] Loading special item graphics...\n");
  load_special_gfx();

  /* Distros: */
  // printf("[DEBUG] Loading coins (distros)...\n");
  img_distro[0] = new Surface(datadir + "/images/tilesets/coin1.png", USE_ALPHA);
  img_distro[1] = new Surface(datadir + "/images/tilesets/coin2.png", USE_ALPHA);
  img_distro[2] = new Surface(datadir + "/images/tilesets/coin3.png", USE_ALPHA);
  img_distro[3] = new Surface(datadir + "/images/tilesets/coin2.png", USE_ALPHA);

  /* Tux life: */
  // printf("[DEBUG] Loading tux life icon...\n");
  tux_life = new Surface(datadir + "/images/shared/tux-life.png", USE_ALPHA);

  /* Sound effects: */
  // printf("[DEBUG] Loading sounds...\n");
  for (i = 0; i < NUM_SOUNDS; i++) {
    sounds[i] = load_sound(datadir + soundfilenames[i]);
    // printf("[DEBUG] Loaded sound[%d]: %s\n", i, soundfilenames[i].c_str());
  }

  /* Music: */
  // printf("[DEBUG] Loading music...\n");
  herring_song = music_manager->load_music(datadir + "/music/SALCON.MOD");
  // printf("[DEBUG] Herring song loaded.\n");

  level_end_song = music_manager->load_music(datadir + "/music/leveldone.mod");
  // printf("[DEBUG] Level end song loaded.\n");

  // printf("[DEBUG] loadshared: Finished loading shared resources.\n");
}
